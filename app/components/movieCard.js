    ...
    <div className="text-center">
      <div className="relative inline-block">
        ...
        {showHeart && (
          ...
          >
            <span className="flex items-center justify-center bg-black/5 rounded-full p-2">
            {isFave ? (
              <FaHeart className="text-red-600 text-6xl duration-300 hover:scale-105" />
            ) : (
              <FaRegHeart className="text-white text-6xl duration-300 hover:scale-105" />
            )}
            </span>
          </button>
        )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-black border-2 border-red-600 rounded-xl shadow-2xl p-8 max-w-md w-full mx-4 text-center">
            ...
            <p className="text-lg text-gray-200 mb-8">
              You need to log in to add movies to your favorites.
            </p>
